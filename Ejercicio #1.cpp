...
void insert_data_db(){
	...
	cout<<"Tipo de cuadeno quiere de la libreria:  \n"<<endl;
	cout<<"Modelo de cuaderno:  "<<endl;
	cin>>modelo;
	cout<<"Catidad de cuaderno quiere:  "<<endl;
	cin>>cantidad;
	cout<<"Dia que compro el cuaderno:  "<<endl;
	cin>>dia;
